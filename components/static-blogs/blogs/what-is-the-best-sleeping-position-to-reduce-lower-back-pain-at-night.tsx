...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "about": {
        "@type": "Thing",
        "name": "Sleeping Positions for Lower Back Pain Relief",
        "description":
          "An overview of optimal sleep postures, spinal alignment techniques, knee pillow placement, and chiropractic guidance to prevent nighttime low back pain.",
      },
      "keywords": [
        "best sleeping position for lower back pain",
        "sleeping position to reduce lower back pain",
        "lower back pain at night",
        "chiropractic sleep tips",
        "spinal alignment sleep posture",
        "side sleeping knee pillow",
        "back pain chiropractor Tampa",
        "sciatica sleep position",
      ],
      "author": {
        "@type": "Organization",
