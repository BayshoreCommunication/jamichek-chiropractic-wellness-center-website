      ...
      <div className="p-6 flex flex-col flex-1 justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            From back pain to headaches, our chiropractic care targets the root
            cause — not just the symptoms — so you can move freely and live
            without limits.
          </p>
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-1 justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            ...
            adjustments, spinal decompression therapy, rehabilitation exercises,
            and weight loss, to help our patients achieve optimal health.
          </p>
        </div>
      </div>
    </div>
